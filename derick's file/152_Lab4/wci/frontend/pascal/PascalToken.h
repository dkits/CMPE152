...
{
    // Reserved words.
    AND, ARRAY, BEGIN, CASE, WHEN, OTHERWISE, CONST, DIV, DO, DOWNTO, ELSE, END,
    ...
    GREATER_EQUALS, THEN_EQUALS, GREATER_THAN, LEFT_PAREN, RIGHT_PAREN,
...
constexpr PascalTokenType PT_THEN_EQUALS = PascalTokenType::THEN_EQUALS;
